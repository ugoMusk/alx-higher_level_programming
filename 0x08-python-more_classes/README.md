...
In this project, I practiced more of python's object-oriented programming in paradigm. I learned and implimented class methods, static methods, class vs instance attributes, andbhow to use the special `__str__` and `__repr__` methods.

##### Author: ThankGod Ugobo

## Tests :heavy_check_mark:

- [Note](./#): Each file contains a main.py test companion file. Provided by Holberton School.
