...
In this project, i learnt about relational databases.I practiced at an introductory level the SQL data definitions and data manipulation language, implemented subqueries, and functions.
